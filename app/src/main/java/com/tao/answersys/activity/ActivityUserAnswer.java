...
public class ActivityUserAnswer extends ActivityBase{
    private final static String TITLE_MY_ANSWER = "我的回答";
    ...
    private void initLessonList() {
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.user_answer_listview);
        ...
        new ActivityUserAnswer.AsyncTaskNews().execute(1);
    }
    ...
    public class AsyncTaskNews extends AsyncTask<Integer, String, List<Question>>{
        ...
        protected List<Question> doInBackground(Integer...params) {
            ...
            return mBizQuestion.getUserAnswer(page);
        }
    ...
    public void onError(EventUserAnswerItemClick event) {
        Intent intent = new Intent(ActivityUserAnswer.this, ActivityQuestionDetail.class);
